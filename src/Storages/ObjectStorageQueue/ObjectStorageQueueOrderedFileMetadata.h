...
private:
    ...
    {
        explicit ProcessingStateFromKeeper() = default;
        explicit ProcessingStateFromKeeper(bool is_failed_) : is_failed(is_failed_) {}
        explicit ProcessingStateFromKeeper(const std::string & last_processed_path_) : last_processed_path(last_processed_path_) {}
